    ...
    def validate_model_field(cls, v, info): # Renamed to avoid conflict
        ...
        if 'haiku' in clean_v.lower():
            if PREFERRED_PROVIDER == "google" and SMALL_MODEL in GEMINI_MODELS:
                ...
                # Ensure we have the correct deepseek/ prefix
                if SMALL_MODEL.startswith(("deepseek/", "a4f/")):
                    new_model = SMALL_MODEL.replace("a4f/", "deepseek/")
                else:
        ...
        # Map Sonnet to BIG_MODEL based on provider preference
            ...
            if PREFERRED_PROVIDER == "google" and BIG_MODEL in GEMINI_MODELS:
                ...
                if BIG_MODEL.startswith(("deepseek/", "a4f/")):
                    new_model = BIG_MODEL.replace("a4f/", "deepseek/")
                else:
        ...
        # Add prefixes to non-mapped models if they match known lists
            ...
            if clean_v in GEMINI_MODELS and not v.startswith('gemini/'):
                ...
                mapped = True # Technically mapped to add prefix
            elif clean_v in A4F_MODELS and not v.startswith('deepseek/'):
...
async def create_message(
    ...
    try:
        ...
        if "openai" in litellm_request["model"] or "deepseek" in litellm_request["model"] and "messages" in litellm_request:
